...
@section('title', __('certificates.edit_certificate'))
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('certificates.edit_certificate') }}</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('certificates.index') }}">{{ __('certificates.certificates') }}</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('certificates.show', $certificate) }}">{{ $certificate->name }}</a></li>
                        <li class="breadcrumb-item active">{{ __('certificates.edit') }}</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <form action="{{ route('certificates.update', $certificate) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                               id="name" name="name" value="{{ old('name', $certificate->name) }}" required maxlength="255">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('subject') is-invalid @enderror"
                               id="subject" name="subject" value="{{ old('subject', $certificate->subject) }}" required maxlength="255">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('certificate_type') is-invalid @enderror"
                            ...
                            @foreach($certificateTypes as $key => $value)
                                <option value="{{ $key }}" {{ old('certificate_type', $certificate->certificate_type) == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('level') is-invalid @enderror"
                            ...
                            @foreach($certificateLevels as $key => $value)
                                <option value="{{ $key }}" {{ old('level', $certificate->level) == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('language') is-invalid @enderror"
                            ...
                            <option value="en" {{ old('language', $certificate->language) == 'en' ? 'selected' : '' }}>
                                {{ __('certificates.english') }}
                            </option>
                            <option value="it" {{ old('language', $certificate->language) == 'it' ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('company_id') is-invalid @enderror"
                            ...
                            @foreach($companies as $company)
                                <option value="{{ $company->id }}" {{ old('company_id', $certificate->company_id) == $company->id ? 'selected' : '' }}>
                                    {{ $company->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('training_organization') is-invalid @enderror"
                               id="training_organization" name="training_organization" value="{{ old('training_organization', $certificate->training_organization) }}"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('training_organization_code') is-invalid @enderror"
                               ...
                               value="{{ old('training_organization_code', $certificate->training_organization_code) }}" maxlength="100">
                        <div class="form-text">{{ __('certificates.optional_field') }}</div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('instructor_name') is-invalid @enderror"
                               id="instructor_name" name="instructor_name" value="{{ old('instructor_name', $certificate->instructor_name) }}" maxlength="255">
                        <div class="form-text">{{ __('certificates.optional_field') }}</div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('duration_months') is-invalid @enderror"
                               id="duration_months" name="duration_months" value="{{ old('duration_months', $certificate->duration_months) }}"
                               min="1" max="120">
                        <div class="form-text">{{ __('certificates.optional_field') }}</div>
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('training_organization_address') is-invalid @enderror"
                                  ...
                                  rows="2" maxlength="500">{{ old('training_organization_address', $certificate->training_organization_address) }}</textarea>
                        <div class="form-text">{{ __('certificates.optional_field') }}</div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('certificate_number') is-invalid @enderror"
                               id="certificate_number" name="certificate_number" value="{{ old('certificate_number', $certificate->certificate_number) }}"
                               maxlength="255">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('issue_date') is-invalid @enderror"
                               id="issue_date" name="issue_date" value="{{ old('issue_date', $certificate->issue_date->format('Y-m-d')) }}" required>
                        @error('issue_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('expiration_date') is-invalid @enderror"
                               id="expiration_date" name="expiration_date" value="{{ old('expiration_date', $certificate->expiration_date->format('Y-m-d')) }}" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                            ...
                            <option value="pending" {{ old('status', $certificate->status) == 'pending' ? 'selected' : '' }}>
                                {{ __('certificates.status_pending') }}
                            </option>
                            <option value="suspended" {{ old('status', $certificate->status) == 'suspended' ? 'selected' : '' }}>
                                {{ __('certificates.status_suspended') }}
                            </option>
                            <option value="expired" {{ old('status', $certificate->status) == 'expired' ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        <div class="form-check mt-4">
                            <input type="checkbox" class="form-check-input @error('is_public') is-invalid @enderror"
                                   id="is_public" name="is_public" value="1" {{ old('is_public', $certificate->is_public) ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-info">
                        <strong>{{ __('certificates.verification_code') }}:</strong> {{ $certificate->verification_code }}
                        <br>
                        <small>{{ __('certificates.verification_code_help') }}</small>
                    </div>
                </div>
            </div>
            @endif
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('hours_completed') is-invalid @enderror"
                               id="hours_completed" name="hours_completed" value="{{ old('hours_completed', $certificate->hours_completed) }}"
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('credits') is-invalid @enderror"
                               id="credits" name="credits" value="{{ old('credits', $certificate->credits) }}"
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('score') is-invalid @enderror"
                               id="score" name="score" value="{{ old('score', $certificate->score) }}"
                               min="0" max="100">
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('grade') is-invalid @enderror"
                               id="grade" name="grade" value="{{ old('grade', $certificate->grade) }}" maxlength="50">
                        @error('grade')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('regulatory_body') is-invalid @enderror"
                               id="regulatory_body" name="regulatory_body" value="{{ old('regulatory_body', $certificate->regulatory_body) }}" maxlength="255">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('compliance_standard') is-invalid @enderror"
                               id="compliance_standard" name="compliance_standard" value="{{ old('compliance_standard', $certificate->compliance_standard) }}"
                               maxlength="255">
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input @error('renewal_required') is-invalid @enderror"
                                   ...
                                   {{ old('renewal_required', $certificate->renewal_required) ? 'checked' : '' }}>
                ...
                <div class="col-md-8">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('renewal_period_months') is-invalid @enderror"
                               ...
                               value="{{ old('renewal_period_months', $certificate->renewal_period_months) }}" min="1" max="120">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="file-upload-area">
                            ...
                            @if($certificate->certificate_file_path)
                                <div class="form-text"><small>Upload new file to replace current file</small></div>
                            @endif
                        </div>
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('notes') is-invalid @enderror"
                                  id="notes" name="notes" rows="4" maxlength="2000">{{ old('notes', $certificate->notes) }}</textarea>
        ...
        <div class="form-section">
            <div class="d-flex justify-content-between">
                <a href="{{ route('certificates.show', $certificate) }}" class="btn btn-secondary">
                    <i class="fas fa-arrow-left me-1"></i>{{ __('certificates.back_to_certificates') }}
                </a>

                <div>
                    <a href="{{ route('certificates.show', $certificate) }}" class="btn btn-outline-secondary me-2">
                        <i class="fas fa-times me-1"></i>{{ __('certificates.cancel') }}
                    </a>
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-1"></i>{{ __('certificates.update_certificate') }}
                    </button>
                </div>
            </div>
        </div>

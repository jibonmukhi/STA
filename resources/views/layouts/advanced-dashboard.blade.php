...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <div class="nav-section">
                <div class="nav-item">
                    <a href="#" class="nav-link" onclick="toggleSubmenu('userSubmenu', event)" data-tooltip="Users">
                        <div class="nav-icon">
                            <i class="fas fa-users"></i>
                        </div>
                        <span class="nav-text">Users</span>
                        <i class="fas fa-chevron-down nav-toggle" id="userToggle"></i>
                    </a>
            ...
            <div class="nav-section">
                <div class="nav-item">
                    <a href="#" class="nav-link" onclick="toggleSubmenu('roleSubmenu', event)" data-tooltip="Roles & Permissions">
                        <div class="nav-icon">
                            <i class="fas fa-user-shield"></i>
                        </div>
                        <span class="nav-text">Roles & Permissions</span>
                        <i class="fas fa-chevron-down nav-toggle" id="roleToggle"></i>
                    </a>
                    <div class="nav-submenu" id="roleSubmenu">
            ...
            <div class="nav-section">
                <div class="nav-item">
                    <a href="#" class="nav-link" onclick="toggleSubmenu('companySubmenu', event)" data-tooltip="Companies">
                        <div class="nav-icon">
                            <i class="fas fa-building"></i>
                        </div>
                        <span class="nav-text">Companies</span>
                        <i class="fas fa-chevron-down nav-toggle" id="companyToggle"></i>
                    </a>
                    <div class="nav-submenu" id="companySubmenu">

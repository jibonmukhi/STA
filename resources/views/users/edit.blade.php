                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control datepicker @error('date_of_birth') is-invalid @enderror"
                                       id="date_of_birth_display" name="date_of_birth_display" value="{{ old('date_of_birth', $user->date_of_birth?->format('Y-m-d')) }}"
                                       placeholder="DD/MM/YYYY" autocomplete="off" required readonly>
                                <input type="hidden" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $user->date_of_birth?->format('Y-m-d')) }}">
                                @error('date_of_birth')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load comuni and countries for CF generation
    loadComuni();
    loadCountries();
